...
**Osho Talks** does not collect or receive any personal data. It has no developer-operated servers, analytics, advertising, or tracking.
...
Oshoworld.com and archive.org host the audio files. Apple's iCloud service handles optional sync between your devices. The app does not include analytics, advertising, or tracking services.

## Analytics and tracking

None. The app does not use any analytics or tracking tools.
